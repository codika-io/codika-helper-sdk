 ...
 * Docs Get Command
 *
 * Get an agent document's content (current or specific version).
 *
 * Usage:
 *   codika docs get <projectId> --type brief
 *   codika docs get <projectId> --type brief --version 0.1.0
 *   codika docs get <projectId> --type brief --history
 */
...
export const docsGetCommand = new Command('get')
  .description('Get an agent document (content, version, or history)')
